...
import ImageBgMobile from "../../assets/pages/analytics/getting-most-bg-mobile.svg";
import ImageBgTablet from "../../assets/pages/analytics/getting-most-bg-tablet-plus.svg";
...
const GettingMost = ({
  ...
  return (
    <div className={`grid justify-items-center w-full overflow-x-hidden ${className}`} {...otherProps}>
      <div className="grid relative getting-grid-mobile md:getting-grid-tablet lg:getting-grid-web xl:getting-grid-webHD mb-40px md:mb-90px lg:mb-115px xl:mb-155px xl:mt-150px">
        <img
          src={ImageBgMobile}
          alt="background"
        ...
        <img
          src={ImageBgTablet}
          alt="background"
          className="hidden md:block absolute -z-10 md:-right-495px md:-bottom-70px lg:-right-190px lg:-bottom-70px xl:-right-252px xl:-bottom-100px max-w-none md:w-1640px lg:w-1453px xl:w-2061px"
        />
        ...
        <Border
          borderSide="right"
          className="getting-answer-area1 hidden md:block justify-self-end md:max-h-141px lg:max-h-108px"
        />
        ...
        <Border borderSide="right" className="getting-answer-area2 lg:block justify-self-end hidden lg:max-h-108px" />
        ...
        />
        <Border borderSide="left" className="answer-block-area2 hidden md:block md:max-h-141px lg:max-h-108px" />
        ...
        />
        <Border borderSide="left" className="getting-answer-area3 hidden lg:block lg:max-h-108px" />
      </div>
    </div>
  );
};
